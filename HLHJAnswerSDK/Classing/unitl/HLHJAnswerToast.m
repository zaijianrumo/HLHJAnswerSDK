...
@implementation HLHJAnswerToast
...
+ (void)hsShowCenterWithText:(NSString *)text {
    [HLHJAnswerToast hsShowCenterWithText:text duration:ToastDispalyDuration];
}
...
+ (void)hsShowCenterWithText:(NSString *)text duration:(CGFloat)duration {
    HLHJAnswerToast *toast = [[HLHJAnswerToast alloc] initWithText:text];
...
+ (void)hsShowTopWithText:(NSString *)text {
    [HLHJAnswerToast hsShowTopWithText:text topOffset:ToastSpace duration:ToastDispalyDuration];
}
...
+ (void)hsShowTopWithText:(NSString *)text duration:(CGFloat)duration {
    [HLHJAnswerToast hsShowTopWithText:text topOffset:ToastSpace duration:duration];
}
...
+ (void)hsShowTopWithText:(NSString *)text topOffset:(CGFloat)topOffset {
    [HLHJAnswerToast hsShowTopWithText:text topOffset:topOffset duration:ToastDispalyDuration];
}
...
+ (void)hsShowBottomWithText:(NSString *)text {
    [HLHJAnswerToast hsShowBottomWithText:text bottomOffset:ToastSpace duration:ToastDispalyDuration];
}
...
+ (void)hsShowBottomWithText:(NSString *)text duration:(CGFloat)duration {
    [HLHJAnswerToast hsShowBottomWithText:text bottomOffset:ToastSpace duration:duration];
}
...
+ (void)hsShowBottomWithText:(NSString *)text bottomOffset:(CGFloat)bottomOffset {
    [HLHJAnswerToast hsShowBottomWithText:text bottomOffset:bottomOffset duration:ToastDispalyDuration];
}
